-- 1. Limpeza de tabelas antigas (se existirem) para evitar conflitos
DROP TABLE IF EXISTS planos_aula;
DROP TABLE IF EXISTS atividades_geradas;
DROP TABLE IF EXISTS estudantes;

-- 2. Criação da tabela de Estudantes simplificada
CREATE TABLE estudantes (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    nome VARCHAR(255) NOT NULL,
    turma VARCHAR(50),
    turno VARCHAR(50),
    neurodivergencia TEXT NOT NULL,
...
-- 3. Criação da tabela para salvar as atividades geradas
...
-- 4. Inserção de todos os alunos com seus dados do PEI
INSERT INTO estudantes (nome, turma, turno, neurodivergencia, potencialidades, desafios, interesses, suporte_recomendado) VALUES
...
-- 5. Desativar RLS para garantir acesso direto da aplicação
ALTER TABLE estudantes DISABLE ROW LEVEL SECURITY;
ALTER TABLE atividades_geradas DISABLE ROW LEVEL SECURITY;
